...
public class TruckDisplay implements DisplayStrategy{
    int start = 1;
    int end = 1;
    @Override
    public void getFreeCount(List<ParkingFloor> floors) {
        for (ParkingFloor floor : floors) {
            ...
            System.out.println("No. of free slots for TRUCK on Floor " + floor.getFloorNo() + ": " + count);
        }
    ...
    public void getFreeSlots(List<ParkingFloor> floors) {
        for (ParkingFloor floor : floors) {
            ...
            System.out.println("Free slots for TRUCK on Floor " + floor.getFloorNo() + ": " + tempFreeSlots);
        }
    ...
    public void getOccupiedSlots(List<ParkingFloor> floors) {
        for (ParkingFloor floor : floors) {
            ...
            System.out.println("Occupied slots for TRUCK on Floor " + floor.getFloorNo() + ": " + tempOccupiedSlots);
        }
